 ...
 *  - El formato del fichero es el siguiente, donde el nombre de cada persona está en una línea distinta:
 *             Maria
 *             Juan
 *             Antonio
 *             Alberto
 ...
 *
 *   - Se recomienda leer los datos del fichero caracter a caracter, e implementar
 *     de forma privada al módulo la siguiente función:
 *
 *        void leerNombre(char *persona,FILE *fd);
 *
 *     Esta función leerá del fichero caracter a caracter hasta encontrar el caracter
 *     '\0' y almacenará todos esos caracteres (incluyendo '\0' en el parámetro persona
 */
 ...
 *   - Que la lista esté vacía (el puntero sig y ant del nuevo nodo apuntan a sí mismo)
 ...
 *    - Primero nos colocamos en el nodo indicado en nodoIni, empezando a contar desde el
 *      primer elemento de la lista (que sería el nodo 0)
 *    - Después nos movemos a la derecha o a la izquierda en la lista, de forma circular, tantos
 *      nodos como indica el parámetro dist.
