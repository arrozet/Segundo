...
public class ComparaMetodos {
	...
	public static void main(String[] args) {
		int [] tam = {1, 5, 10, 50, 100, 500, 1000};//Selecciona tamaños de entrada
		int numPruebas = 20;//Selecciona número de pruebas por tamaño
		String [] competidores = {"N", "NLOGN", "N2"};//Selecciona orden de los algoritmos competidores
		...
		for (int c = 0; c < competidores.length; c++) {
			...
			System.out.println("Tamaños de entrada\tROZ\t\t" + competidor.ordenPeorCaso()+"\t\tT1/T2");
